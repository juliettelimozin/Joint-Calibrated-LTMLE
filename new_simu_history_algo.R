...
DATA_GEN_cont_outcome_treatment_switch_history<-function(ns, nv, conf = 0.5, treat_prev = 0,
  ...
  for (k in 2:nvisit){  
    ...
    #lpp<- 2*Ap[seqlist[[k]]] -5*(1-Ap[seqlist[[k]]]) + 2*(X1[seqlist[[k]]]+X2[seqlist[[k]]]) +3*X1[seqlist[[k]]]*X2[seqlist[[k]]] + 2*(X1p[seqlist[[k]]]+X2p[seqlist[[k]]]) 
    
    lpp<- 2*Ap[seqlist[[k]]] -3*(1-Ap[seqlist[[k]]]) + 0.25*(X1[seqlist[[k]]]+X2[seqlist[[k]]]) +0.3*X1[seqlist[[k]]]*X2[seqlist[[k]]] + 0.25*(X1p[seqlist[[k]]]+X2p[seqlist[[k]]]) 
    ...
    if (all_treat == TRUE){
      ...
      ps[seqlist[[k]]] <- Ap[seqlist[[k]]]/(1+exp(-lpp))+ (1-Ap[seqlist[[k]]])*(1-1/(1+exp(-lpp)))
    }
    }
    ##Generate outcome
  ...
  DATA<-data.frame(ID,t=rep(c(0:(nv-1)),ns),A,Ap,CAp,X1,X2,X1p,X2p, Y,ps)
...
############################### CHECK DATA SPARSITY ############################
simdata<-DATA_GEN_cont_outcome_treatment_switch_history(ns = 10000,nv = 5,treat_prev =  0.5,
...
library(cobalt)
bal.tab(simdata[simdata$RA == 1 & simdata$t == 4,c('X1', 'X2')], treat = 'A' , data = simdata[simdata$RA == 1 & simdata$t == 4,])
bal.plot(simdata[simdata$RA == 1 & simdata$t == 4,c('X1', 'X2')], treat = 'A' , data = simdata[simdata$RA == 1 & simdata$t == 4,])
...
for (l in 1:6){
  oper <- foreach(i = 1:iters,.combine=cbind) %dopar% {
    tryCatch({
      ...
      #                                     "SL.bayesglm","SL.stepAIC","SL.step.interaction","SL.glmnet","SL.ridge"))
      # 
      wideSimdata$Y1_4 <- wideSimdata$y4pred1 <- predict.glm(q4,type = "response", newdata = wideSimdata %>% mutate(A_4 = 1, A_3 = 1))
      wideSimdata$missY1_4 <-wideSimdata$y4predmiss1 <- predict.glm(q4miss,type = "response", newdata = wideSimdata %>% mutate(A_4 = 1, A_3 = 1))
      wideSimdata$funcmissY1_4 <-wideSimdata$y4predfuncmiss1 <- predict.glm(q4funcmiss,type = "response", newdata = wideSimdata %>% mutate(A_4 = 1, A_3 = 1))
      ...
      # wideSimdata$SLY1_4 <- wideSimdata$y4predSL1 <- predict(q4SL, wideSimdata[,c("X1_0", "X1_1", "X1_2", "X1_3","X1_4",
      #                                                       "X2_0", "X2_1", "X2_2", "X2_3", "X2_4",
      #                                                       "A_0", "A_1", "A_2", "A_3", "A_4")] %>% mutate(A_4 = 1, A_3 = 1,A_2 = 1, A_1 = 1,A_0 = 1),
      #                                  onlySL = TRUE)$pred
      # wideSimdata$funcmissSLY1_4 <- wideSimdata$y4predfuncmissSL1 <- predict(q4funcmissSL, wideSimdata[,c("missX1_0", "missX1_1", "missX1_2", "missX1_3","missX1_4",
      #                                                               "missX2_0", "missX2_1", "missX2_2", "missX2_3", "missX2_4",
      #                                                               "A_0", "A_1", "A_2", "A_3", "A_4")] %>% mutate(A_4 = 1, A_3 = 1,A_2 = 1, A_1 = 1,A_0 = 1),
      #                                  onlySL = TRUE)$pred
      # 
      wideSimdata$Y0_4 <-wideSimdata$y4pred0 <- predict.glm(q4,type = "response", newdata = wideSimdata %>% mutate(A_4 = 0, A_3 = 0))
      wideSimdata$missY0_4 <-wideSimdata$y4predmiss0 <- predict.glm(q4miss,type = "response", newdata = wideSimdata %>% mutate(A_4 = 0, A_3 = 0))
      wideSimdata$funcmissY0_4 <-wideSimdata$y4predfuncmiss0 <- predict.glm(q4funcmiss,type = "response", newdata = wideSimdata %>% mutate(A_4 = 0, A_3 = 0))
      ...
      # wideSimdata$SLY0_4 <- wideSimdata$y4predSL0 <- predict(q4SL, wideSimdata[,c("X1_0", "X1_1", "X1_2", "X1_3","X1_4",
      #                                                       "X2_0", "X2_1", "X2_2", "X2_3", "X2_4",
      #                                                       "A_0", "A_1", "A_2", "A_3", "A_4")] %>% mutate(A_4 = 0, A_3 = 0,A_2 = 0, A_1 = 0,A_0 = 0),
      #                                  onlySL = TRUE)$pred
      # wideSimdata$funcmissSLY0_4 <- wideSimdata$y4predfuncmissSL0 <- predict(q4funcmissSL, wideSimdata[,c("missX1_0", "missX1_1", "missX1_2", "missX1_3","missX1_4",
      #                                                               "missX2_0", "missX2_1", "missX2_2", "missX2_3", "missX2_4",
      #                                                               "A_0", "A_1", "A_2", "A_3", "A_4")] %>% mutate(A_4 = 0, A_3 = 0,A_2 = 0, A_1 = 0,A_0 = 0),
      #                                          onlySL = TRUE)$pred
      ...
      #                       SL.library = c("SL.glm", "SL.glm.interaction",
      #                                      "SL.bayesglm","SL.stepAIC","SL.step.interaction","SL.glmnet","SL.ridge"))
      # q3funcmissSL0 <- SuperLearner(Y =  wideSimdata$y4predfuncmissSL0,
      #                               X = wideSimdata[,c("missX1_0", "missX1_1", "missX1_2", "missX1_3",
      #                                                  "missX2_0", "missX2_1", "missX2_2", "missX2_3",
      #                                                  "A_0", "A_1", "A_2", "A_3")],
      #                               family = gaussian(),
      ...
      wideSimdata$Y1_3 <- wideSimdata$y4pred1 <- predict.glm(q3_1,type = "response", newdata = wideSimdata %>% mutate(A_3 = 1, A_2 = 1))
      wideSimdata$missY1_3 <-  wideSimdata$y4predmiss1 <- predict.glm(q3miss_1,type = "response", newdata = wideSimdata %>% mutate(A_3 = 1, A_2 = 1))
      wideSimdata$funcmissY1_3 <- wideSimdata$y4predfuncmiss1 <- predict.glm(q3funcmiss_1,type = "response", newdata = wideSimdata %>% mutate(A_3 = 1, A_2 = 1))
      ...
      wideSimdata$Y0_3 <- wideSimdata$y4pred0 <- predict.glm(q3_0,type = "response", newdata = wideSimdata %>% mutate(A_3 = 0, A_2 = 0))
      wideSimdata$missY0_3 <- wideSimdata$y4predmiss0 <- predict.glm(q3miss_0,type = "response", newdata = wideSimdata %>% mutate(A_3 = 0, A_2 = 0))
      wideSimdata$funcmissY0_3 <- wideSimdata$y4predfuncmiss0 <- predict.glm(q3funcmiss_0,type = "response", newdata = wideSimdata %>% mutate(A_3 = 0, A_2 = 0))
      ...
      # wideSimdata$SLY1_3 <- wideSimdata$y4predSL1 <- predict(q3SL1, wideSimdata[,c("X1_0", "X1_1", "X1_2","X1_3",
      #                                                       "X2_0", "X2_1", "X2_2", "X2_3", 
      #                                                       "A_0", "A_1", "A_2", "A_3")] %>% mutate(A_3 = 1,A_2 = 1, A_1 = 1,A_0 = 1),
      #                                  onlySL = TRUE)$pred
      # wideSimdata$funcmissSLY1_3 <- wideSimdata$y4predfuncmissSL1 <- predict(q3funcmissSL1, wideSimdata[,c("missX1_0", "missX1_1", "missX1_2", "missX1_3",
      #                                                                       "missX2_0", "missX2_1", "missX2_2", "missX2_3", 
      #                                                                       "A_0", "A_1", "A_2", "A_3")] %>% mutate(A_3 = 1,A_2 = 1, A_1 = 1,A_0 = 1),
      #                                          onlySL = TRUE)$pred
      # 
      # wideSimdata$SLY0_3 <- wideSimdata$y4predSL0 <- predict(q3SL0, wideSimdata[,c("X1_0", "X1_1", "X1_2", "X1_3",
      #                                                       "X2_0", "X2_1", "X2_2", "X2_3",
      #                                                       "A_0", "A_1", "A_2", "A_3")] %>% mutate(A_3 = 0,A_2 = 0, A_1 = 0,A_0 = 0),
      #                                  onlySL = TRUE)$pred
      # wideSimdata$funcmissSLY0_3 <-wideSimdata$y4predfuncmissSL0 <- predict(q3funcmissSL0, wideSimdata[,c("missX1_0", "missX1_1", "missX1_2", "missX1_3",
      #                                                                       "missX2_0", "missX2_1", "missX2_2", "missX2_3",
      #                                                                       "A_0", "A_1", "A_2", "A_3")] %>% mutate(A_3 = 0,A_2 = 0, A_1 = 0,A_0 = 0),
      #                                          onlySL = TRUE)$pred
      ...
      #                       SL.library = c("SL.glm", "SL.glm.interaction",
      #                                      "SL.bayesglm","SL.stepAIC","SL.step.interaction","SL.glmnet","SL.ridge"))
      # q2funcmissSL0 <- SuperLearner(Y =  wideSimdata$y4predfuncmissSL0,
      #                               X = wideSimdata[,c("missX1_0", "missX1_1", "missX1_2", 
      #                                                  "missX2_0", "missX2_1", "missX2_2",
      #                                                  "A_0", "A_1", "A_2")],
      #                               family = gaussian(),
      ...
      #                                              "SL.bayesglm","SL.stepAIC","SL.step.interaction","SL.glmnet","SL.ridge"))
      # 
      wideSimdata$Y1_2 <- wideSimdata$y4pred1 <- predict.glm(q2_1,type = "response", newdata = wideSimdata %>% mutate(A_2 = 1, A_1 = 1))
      wideSimdata$missY1_2 <- wideSimdata$y4predmiss1 <- predict.glm(q2miss_1,type = "response", newdata = wideSimdata %>% mutate(A_2 = 1, A_1 = 1))
      wideSimdata$funcmissY1_2 <- wideSimdata$y4predfuncmiss1 <- predict.glm(q2funcmiss_1,type = "response", newdata = wideSimdata %>% mutate(A_2 = 1, A_1 = 1))
      ...
      wideSimdata$Y0_2 <- wideSimdata$y4pred0 <- predict.glm(q2_0,type = "response", newdata = wideSimdata %>% mutate(A_2 = 0, A_1 = 0))
      wideSimdata$missY0_2 <- wideSimdata$y4predmiss0 <- predict.glm(q2miss_0,type = "response", newdata = wideSimdata %>% mutate(A_2 = 0, A_1 = 0))
      wideSimdata$funcmissY0_2 <- wideSimdata$y4predfuncmiss0 <- predict.glm(q2funcmiss_0,type = "response", newdata = wideSimdata %>% mutate(A_2 = 0, A_1 = 0))
      ...
      # wideSimdata$SLY1_2 <-wideSimdata$y4predSL1 <- predict(q2SL1, wideSimdata[,c("X1_0", "X1_1", "X1_2",
      #                                                        "X2_0", "X2_1", "X2_2", 
      #                                                        "A_0", "A_1", "A_2")] %>% mutate(A_2 = 1, A_1 = 1,A_0 = 1),
      #                                  onlySL = TRUE)$pred
      # wideSimdata$funcmissSLY1_2 <- wideSimdata$y4predfuncmissSL1 <- predict(q2funcmissSL1, wideSimdata[,c("missX1_0", "missX1_1", "missX1_2",
      #                                                                        "missX2_0", "missX2_1", "missX2_2",
      #                                                                        "A_0", "A_1", "A_2")] %>% mutate(A_2 = 1, A_1 = 1,A_0 = 1),
      #                                          onlySL = TRUE)$pred
      # 
      # wideSimdata$SLY0_2 <- wideSimdata$y4predSL0 <- predict(q2SL0, wideSimdata[,c("X1_0", "X1_1", "X1_2",
      #                                                        "X2_0", "X2_1", "X2_2", 
      #                                                        "A_0", "A_1", "A_2")] %>% mutate(A_2 = 0, A_1 = 0,A_0 = 0),
      #                                  onlySL = TRUE)$pred
      # wideSimdata$funcmissSLY0_2 <-wideSimdata$y4predfuncmissSL0 <- predict(q2funcmissSL0, wideSimdata[,c("missX1_0", "missX1_1", "missX1_2",
      #                                                                        "missX2_0", "missX2_1", "missX2_2", 
      #                                                                        "A_0", "A_1", "A_2")] %>% mutate(A_2 = 0, A_1 = 0,A_0 = 0),
      #                                          onlySL = TRUE)$pred
      ...
      #                       SL.library = c("SL.glm", "SL.glm.interaction",
      #                                      "SL.bayesglm","SL.stepAIC","SL.step.interaction","SL.glmnet","SL.ridge"))
      # q1funcmissSL0 <- SuperLearner(Y =  wideSimdata$y4predfuncmissSL0,
      #                               X = wideSimdata[,c("missX1_0", "missX1_1", 
      #                                                  "missX2_0", "missX2_1",
      #                                                  "A_0", "A_1")],
      #                               family = gaussian(),
      ...
      # 
      # 
      wideSimdata$Y1_1 <- wideSimdata$y4pred1 <- predict.glm(q1_1,type = "response", newdata = wideSimdata %>% mutate(A_1 = 1, A_0 = 1))
      wideSimdata$missY1_1 <- wideSimdata$y4predmiss1 <- predict.glm(q1miss_1,type = "response", newdata = wideSimdata %>% mutate(A_1 = 1, A_0 = 1))
      wideSimdata$funcmissY1_1 <- wideSimdata$y4predfuncmiss1 <- predict.glm(q1funcmiss_1,type = "response", newdata = wideSimdata %>% mutate(A_1 = 1, A_0 = 1))
      ...
      wideSimdata$Y0_1 <- wideSimdata$y4pred0 <- predict.glm(q1_0,type = "response", newdata = wideSimdata %>% mutate(A_1 = 0, A_0 = 0))
      wideSimdata$missY0_1 <- wideSimdata$y4predmiss0 <- predict.glm(q1miss_0,type = "response", newdata = wideSimdata %>% mutate(A_1 = 0, A_0 = 0))
      wideSimdata$funcmissY0_1 <- wideSimdata$y4predfuncmiss0 <- predict.glm(q1funcmiss_0,type = "response", newdata = wideSimdata %>% mutate(A_1 = 0, A_0 = 0))
      ...
      # wideSimdata$SLY1_1 <- wideSimdata$y4predSL1 <- predict(q1SL1, wideSimdata[,c("X1_0", "X1_1",
      #                                                        "X2_0", "X2_1", 
      #                                                        "A_0", "A_1")] %>% mutate(A_1 = 1,A_0 = 1),
      #                                  onlySL = TRUE)$pred
      # wideSimdata$funcmissSLY1_1 <- wideSimdata$y4predfuncmissSL1 <- predict(q1funcmissSL1, wideSimdata[,c("missX1_0", "missX1_1", 
      #                                                                        "missX2_0", "missX2_1", 
      #                                                                        "A_0", "A_1")] %>% mutate(A_1 = 1,A_0 = 1),
      #                                          onlySL = TRUE)$pred
      # 
      # wideSimdata$SLY0_1 <- wideSimdata$y4predSL0 <- predict(q1SL0, wideSimdata[,c("X1_0", "X1_1",
      #                                                        "X2_0", "X2_1", 
      #                                                        "A_0", "A_1")] %>% mutate(A_1 = 0,A_0 = 0),
      #                                  onlySL = TRUE)$pred
      # wideSimdata$funcmissSLY0_1 <-  wideSimdata$y4predfuncmissSL0 <- predict(q1funcmissSL0, wideSimdata[,c("missX1_0", "missX1_1", 
      #                                                                        "missX2_0", "missX2_1",
      #                                                                        "A_0", "A_1")] %>% mutate(A_1 = 0,A_0 = 0),
      #                                          onlySL = TRUE)$pred
      # 
      ...
      #                       SL.library = c("SL.glm", "SL.glm.interaction",
      #                                      "SL.bayesglm","SL.stepAIC","SL.step.interaction","SL.glmnet","SL.ridge"))
      # q0funcmissSL0 <- SuperLearner(Y =  wideSimdata$y4predfuncmissSL0,
      #                               X = wideSimdata[,c("missX1_0", 
      #                                                  "missX2_0", 
      #                                                  "A_0")],
      #                               family = gaussian(),
      ...
      #                                              "SL.bayesglm","SL.stepAIC","SL.step.interaction","SL.glmnet","SL.ridge"))
      # 
      wideSimdata$Y1_0 <- wideSimdata$y4pred1 <- predict.glm(q0_1,type = "response", newdata = wideSimdata %>% mutate(A_0 = 1))
      wideSimdata$missY1_0 <- wideSimdata$y4predmiss1 <- predict.glm(q0miss_1,type = "response", newdata = wideSimdata %>% mutate(A_0 = 1))
      wideSimdata$funcmissY1_0 <- wideSimdata$y4predfuncmiss1 <- predict.glm(q0funcmiss_1,type = "response", newdata = wideSimdata %>% mutate(A_0 = 1))
      ...
      wideSimdata$Y0_0 <- wideSimdata$y4pred0 <- predict.glm(q0_0,type = "response", newdata = wideSimdata %>% mutate(A_0 = 0))
      wideSimdata$missY0_0 <- wideSimdata$y4predmiss0 <- predict.glm(q0miss_0,type = "response", newdata = wideSimdata %>% mutate(A_0 = 0))
      wideSimdata$funcmissY0_0 <- wideSimdata$y4predfuncmiss0 <- predict.glm(q0funcmiss_0,type = "response", newdata = wideSimdata %>% mutate(A_0 = 0))
      ...
      # wideSimdata$SLY1_0 <- wideSimdata$y4predSL1 <- predict(q0SL1, wideSimdata[,c("X1_0",
      #                                                        "X2_0", 
      #                                                        "A_0")] %>% mutate(A_0 = 1),
      #                                  onlySL = TRUE)$pred
      # wideSimdata$funcmissSLY1_0 <- wideSimdata$y4predfuncmissSL1 <- predict(q0funcmissSL1, wideSimdata[,c("missX1_0",
      #                                                                        "missX2_0", 
      #                                                                        "A_0")] %>% mutate(A_0 = 1),
      #                                          onlySL = TRUE)$pred
      # 
      # wideSimdata$SLY0_0 <- wideSimdata$y4predSL0 <- predict(q0SL0, wideSimdata[,c("X1_0",
      #                                                        "X2_0",
      #                                                        "A_0")] %>% mutate(A_0 = 0),
      #                                  onlySL = TRUE)$pred
      # wideSimdata$funcmissSLY0_0 <- wideSimdata$y4predfuncmissSL0 <- predict(q0funcmissSL0, wideSimdata[,c("missX1_0",
      #                                                                        "missX2_0",
      #                                                                        "A_0")] %>% mutate(A_0 = 0),
      #                                          onlySL = TRUE)$pred
      ...
      switch_data$trueIPW <- simdatafinal1$data[simdatafinal1$data$RA == 1,]$true_weights
      
      ############## BALANCE SUMMARY #######################
      bal.tab(data_restric[data_restric$t == 4 & data_restric$RA == 1,c('X1', 'X2')], treat = 'A' , data = data_restric[data_restric$t == 4 & data_restric$RA == 1,],
              thresholds = c(m = 0.05), int = T)
      
      bal.tab(data_restric[data_restric$t == 4 & data_restric$RA == 1,c('X1', 'X2')], treat = 'A' , data = data_restric[data_restric$t == 4 & data_restric$RA == 1,], weights = switch_data[switch_data$t == 4,c('trueIPW','IPWcorrect',
                                                                                                                                                 'CaliLkcorrect', 'CaliGLkcorrect',
                                                                                                                                                 'CaliAllCorrect', 'CaliGLkmiss',
                                                                                                                                                 'CaliAllGLkmiss', 'IPWmiss', 'CaliLkmiss',
                                                                                                                                                 'CaliMissGLkcorrect', 'CaliMissAllGLkcorrect',
                                                                                                                                                 'CaliMissGLKmiss',
                                                                                                                                                 'CaliAllmiss', 'IPWfuncmiss','CalifuncmissLk',
                                                                                                                                                 'CalifuncmissGLk',
                                                                                                                                                 'CalifuncmissAll'
      ...
      PP_trueIPW <- glm(data = MSM_data,
                        formula = Y_4 ~ assigned_treatment_0 ,
                        weights = trueIPW_4, family = 'gaussian')
...
#                                   weights = CalifuncmissAllSL_4, family = 'gaussian')
      ...
      ATE <- data.frame(k = c(4)) %>% 
        mutate(ATE_naive = predict.glm(PP_naive, data.frame(assigned_treatment_0 = 1))- predict.glm(PP_naive, data.frame(assigned_treatment_0 = 0)),
               ...
               ATE_trueIPW = predict.glm(PP_trueIPW, data.frame(assigned_treatment_0 = 1)) - predict.glm(PP_trueIPW, data.frame(assigned_treatment_0 = 0)),
      ...
      Y1 <- data.frame(k = c(4)) %>% 
        mutate(EY1_naive = predict.glm(PP_naive, data.frame(assigned_treatment_0 = 1)),
               ...
               EY1_trueIPW = predict.glm(PP_trueIPW, data.frame(assigned_treatment_0 = 1)), 
      ...
      Y0 <- data.frame(k = c(4)) %>% 
        mutate(EY0_naive = predict.glm(PP_naive, data.frame(assigned_treatment_0 = 0)),
               ...
               EY0_trueIPW = predict.glm(PP_trueIPW, data.frame(assigned_treatment_0 = 0)), 
...
bias_ate <- array(,dim = c(21,7))
sd_ate <- array(,dim = c(21,7))
mae_ate <- array(,dim = c(21,7))
medae_ate <- array(,dim = c(21,7))
rootmse_ate <- array(,dim = c(21,7))

bias_EY1 <- array(,dim = c(21,7))
sd_EY1 <- array(,dim = c(21,7))
mae_EY1 <- array(,dim = c(21,7))
medae_EY1 <- array(,dim = c(21,7))
rootmse_EY1 <- array(,dim = c(21,7))

bias_EY0 <- array(,dim = c(21,7))
sd_EY0 <- array(,dim = c(21,7))
mae_EY0 <- array(,dim = c(21,7))
medae_EY0 <- array(,dim = c(21,7))
rootmse_EY0 <- array(,dim = c(21,7))
...
for (l in 1:6){
  ...
  bias_ate[,1] <- colnames(ate_all[,-22])
  sd_ate[,1] <- colnames(ate_all[,-22])
  mae_ate[,1] <- colnames(ate_all[,-22])
  medae_ate[,1] <- colnames(ate_all[,-22])
  rootmse_ate[,1] <- colnames(ate_all[,-22])
  
  bias_ate[,l+1] <- colMeans(ate_all[,-22]) - true_ATE
  sd_ate[,l+1] <- colSds(as.matrix(ate_all[,-22]))
  mae_ate[,l+1] <- colMeans(abs(ate_all[,-22] - true_ATE))
  medae_ate[,l+1] <- colMedians(as.matrix(abs(ate_all[,-22] - true_ATE)))
  rootmse_ate[,l+1] <- sqrt(as.numeric(bias_ate[,l+1])^2 +as.numeric(sd_ate[,l+1])^2)
  
  bias_EY1[,1] <- colnames(EY1_all[,-22])
  sd_EY1[,1] <- colnames(EY1_all[,-22])
  mae_EY1[,1] <- colnames(EY1_all[,-22])
  medae_EY1[,1] <- colnames(EY1_all[,-22])
  rootmse_EY1[,1] <- colnames(EY1_all[,-22])
  
  bias_EY1[,l+1] <- colMeans(EY1_all[,-22]) - true_EY1
  sd_EY1[,l+1] <- colSds(as.matrix(EY1_all[,-22]))
  mae_EY1[,l+1] <- colMeans(abs(EY1_all[,-22] - true_EY1))
  medae_EY1[,l+1] <- colMedians(as.matrix(abs(EY1_all[,-22] - true_EY1)))
  rootmse_EY1[,l+1] <- sqrt(as.numeric(bias_EY1[,l+1])^2 +as.numeric(sd_EY1[,l+1])^2)
  
  bias_EY0[,1] <- colnames(EY0_all[,-22])
  sd_EY0[,1] <- colnames(EY0_all[,-22])
  mae_EY0[,1] <- colnames(EY0_all[,-22])
  medae_EY0[,1] <- colnames(EY0_all[,-22])
  rootmse_EY0[,1] <- colnames(EY0_all[,-22])
  
  bias_EY0[,l+1] <- colMeans(EY0_all[,-22]) - true_EY0
  sd_EY0[,l+1] <- colSds(as.matrix(EY0_all[,-22]))
  mae_EY0[,l+1] <- colMeans(abs(EY0_all[,-22] - true_EY0))
  medae_EY0[,l+1] <- colMedians(as.matrix(abs(EY0_all[,-22] - true_EY0)))
