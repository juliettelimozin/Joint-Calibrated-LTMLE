...
simdata<-DATA_GEN_continous_timevarying_outcome_treatment_switch(ns = 1000,nv = 5,
                                                                 treat_prev =  0.5,
                                                                 conf =  1,
                                                                 censor = F)
simdata <- simdata %>% 
...
data_restric <- simdata %>% 
  dplyr::mutate(Z1 =(X1*X2/25 + 0.6)^3, Z2 = exp(X2/2)) %>% 
  dplyr::group_by(ID) %>% 
...
weight_model_miss <- glm(data = weight_training_data, 
...
weight_model$coefficients <- c(-2.5, 5, 1.0, 1.0 )
data_restric$true_p_1 <- 1.0
data_restric[data_restric$t != 0,]$true_p_1 <- predict.glm(weight_model, data_restric[data_restric$t != 0,], type = 'response')
data_restric$miss_p1 <- 1.0
data_restric[data_restric$t != 0,]$miss_p1 <- predict.glm(weight_model_miss, data_restric[data_restric$t != 0,], type = 'response')
...
data_restric <- data_restric %>% 
  ...
  dplyr::mutate(
    ...
    true_wt = ifelse( t == 0, 1.0,ifelse(A == 1, 1/true_p_1, 1/(1-true_p_1))),
    miss_wt = ifelse( t == 0, 1.0,ifelse(A == 1, 1/miss_p1, 1/(1-miss_p1))),
    wtprod = cumprod(wt),
    true_wtprod = cumprod(true_wt),
    miss_wtprod = cumprod(miss_wt),
    weights = ifelse(weights !=0.0,wtprod,0.0),
    true_weights = ifelse(weights !=0.0,true_wtprod,0.0),
    miss_weights = ifelse(weights !=0.0,miss_wtprod,0.0))
...
ggplot(data = data_restric[data_restric$t==1  & data_restric$RA == 1,], aes(x = X1, group = A_0)) +
  geom_histogram()
hist(1/data_restric[data_restric$t==4  & data_restric$RA == 1,]$true_wtprod)

min(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 0,]$true_wtprod)
max(data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 0,]$true_wtprod)
quantile(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 0,]$true_wtprod, 
         probs = c(0.01,0.25,0.5,0.75,0.99))

hist(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 0,]$miss_weights)

min(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 0,]$miss_weights)
max(data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 0,]$miss_weights)
quantile(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 0,]$miss_weights, 
         probs = c(0.01,0.25,0.5,0.75,0.99))


hist(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$true_wtprod)

min(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$true_wtprod)
max(data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$true_wtprod)
quantile(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$true_wtprod, 
         probs = c(0.01,0.25,0.5,0.75,0.99))


hist(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$miss_weights)

min(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$miss_weights)
max(data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$miss_weights)
quantile(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$miss_weights, 
         probs = c(0.01,0.25,0.5,0.75,0.99))

hist(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$weights)

min(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$weights)
max(data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$weights)
quantile(1/data_restric[data_restric$t==4  & data_restric$RA == 1 &data_restric$A0 == 1,]$weights, 
         probs = c(0.01,0.25,0.5,0.75,0.99))
...
weight_model <- glm(data = weight_training_data, 
                    formula = A ~ Ap*Z1 + Ap*Z2, family = 'binomial')
#summary(weight_model)
data_restric$p_1 <- 1.0
data_restric[data_restric$t != 0,]$p_1 <- predict.glm(weight_model, data_restric[data_restric$t != 0,], type = 'response')
data_restric <- data_restric %>% 
