...
simulation <- foreach(i = 1:iters, .combine=cbind) %dopar% {
  ...
  suppressMessages(suppressWarnings({
    ...
    calibrate_always_treated <- calibration_by_time_from_baseline(simdata, var = c("X1", "X2", "X3", "X4"))
    ...
    calibrate_never_treated <- calibration_by_time_from_baseline(simdata, var = c("X1", "X2", "X3", "X4"))
    ...
    Q2_2_fit <- glm(data = wideSimdata, formula = Y_2_scaled ~ 1, family = 'quasibinomial')
    ...
    Q2_1_fit_d1 <- glm(data = fitting_data[1:sample_size,], formula = Q2_2star ~ 1, family = 'quasibinomial')
    Q2_1_fit_d0 <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q2_2star ~ 1, family = 'quasibinomial')
    ...
    Q2_1_fit_d1_cali <- glm(data = fitting_data[1:sample_size,], formula = Q2_2star_cali ~ 1, family = 'quasibinomial')
    Q2_1_fit_d0_cali <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q2_2star_cali ~ 1, family = 'quasibinomial')
    ...
    Q1_1_fit <- glm(data = wideSimdata, formula = Y_1_scaled ~ 1, family = 'quasibinomial')
    ...
    Q1_0_fit_d1 <- glm(data = fitting_data[1:sample_size,], formula = Q1_1star ~ 1, family = 'quasibinomial')
    Q1_0_fit_d0 <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q1_1star ~ 1, family = 'quasibinomial')
    ...
    Q1_0_fit_d1_cali <- glm(data = fitting_data[1:sample_size,], formula = Q1_1star_cali ~ 1, family = 'quasibinomial')
    Q1_0_fit_d0_cali <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q1_1star_cali ~ 1, family = 'quasibinomial')
    ...
    Q0_0_fit <- glm(data = wideSimdata, formula = Y_0_scaled ~ 1, family = 'quasibinomial')
...
cat(paste('Misspecified outcome, correctly specified treatment models'))
