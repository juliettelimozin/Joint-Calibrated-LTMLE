joint_cali_LtmleMSM <- function(simdata){
  ...
  estimates <- c(msm_transformed$coefficients[1],
                 ...
                 msm_transformed_cali$coefficients[1] + 3* msm_transformed_cali$coefficients[2],
                 msm_transformed_cali_aggr$coefficients[1]+  + 3* msm_transformed_cali_aggr$coefficients[2]
  )
  ...
  Q_t <- list(
    ...
    logitQ2_1        = logitQ2_1,
    logitQ2_2        = logitQ2_2,
    logitQ1_0_cali   = logitQ1_0_cali,
    logitQ2_0_cali   = logitQ2_0_cali,
    logitQ2_1_cali   = logitQ2_1_cali,
    logitQ1_0_cali_aggr = logitQ1_0_cali_aggr,
    logitQ2_0_cali_aggr = logitQ2_0_cali_aggr,
    logitQ2_1_cali_aggr = logitQ2_1_cali_aggr
  )
...
MyLtmleMSM_modified <- function(simdata, initial_Q_t = NA, refit_weights = TRUE){
  ...
  Q2_1star_fit_cali <- glm(Q2_2star_cali ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                           data = update_data[regimen_ind == 1,],
                           weights = as.vector(Cweight[regimen_ind == 1]))
  
  Q2_1star_cali <- predict.glm(Q2_1star_fit_cali, newdata = update_data, type = 'response')
  
  Q2_1star_fit_cali_aggr <- glm(Q2_2star_cali_aggr ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                                data = update_data[regimen_ind == 1,],
                                weights = as.vector(Cweight_aggr[regimen_ind == 1]))
  ...
  Q2_0star_fit_cali <- glm(Q2_1star_cali ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                           data = update_data[regimen_ind == 1,],
                           weights = as.vector(Cweight[regimen_ind == 1]))
  
  Q2_0star_cali <- predict.glm(Q2_0star_fit_cali, newdata = update_data, type = 'response')
  
  Q2_0star_fit_cali_aggr <- glm(Q2_1star_cali_aggr ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                                data = update_data[regimen_ind == 1,],
                                weights = as.vector(Cweight_aggr[regimen_ind == 1]))
  ...
  Q1_0star_fit_cali <- glm(Q1_1star_cali ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                           data = update_data[regimen_ind == 1,],
                           weights = as.vector(Cweight[regimen_ind == 1]))
  
  Q1_0star_cali <- predict.glm(Q1_0star_fit_cali, newdata = update_data, type = 'response')
  
  Q1_0star_fit_cali_aggr <- glm(Q1_1star_cali_aggr ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                                data = update_data[regimen_ind == 1,],
                                weights = as.vector(Cweight_aggr[regimen_ind == 1]))
...
MyLtmleMSM_cali_boot <- function(simdata, initial_Q_t = NA, refit_weights = TRUE){
