...
png("HERS_balance_plots_baseline.png", width = 8, height = 4, units = "in", res = 300)
ggarrange(
...
CI_MLE_ATE <- data.frame(
  Visit = 8:12, ATE_strata0 = point_estimate_TMLE$counterfactual_means$EY_always_treated_strata0[1, ] - point_estimate_TMLE$counterfactual_means$EY_never_treated_strata0[1, ],
