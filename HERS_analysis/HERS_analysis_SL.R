...
source("/home/juliette/Calibrated-weights-sequential-trial-emulation/HERS_analysis/hers_ltmle_utils_SL.R")
library(dplyr)
library(MASS)
library(foreach)
library(doParallel)
...
save.image(file = '/home/juliette/Calibrated-weights-sequential-trial-emulation/HERS_analysis/HERS_SL.RData')
