MyLtmleMSM_modified_hers <- function(simdata, initial_Q_t = NA, refit_weights = TRUE){
  if (refit_weights){
    treat_model_A_0 <- glm(A~ sqrtCD4_1 + sqrtCD4_2 +  viral_1 + viral_2 + HIVsym_1+ SITE2 + SITE3 + WHITE + OTHER-1, data = simdata[simdata$t == 0,], family = 'binomial')
    ...
    simdata[simdata$t == 1,]$pr_c <- as.vector(1-predict.glm(censor_model_0, 
                                                             newdata = data.frame(sqrtCD4_1 = simdata[simdata$t == 1,]$lagsqrtCD4_1,
                                                                                  sqrtCD4 = simdata[simdata$t == 1,]$lagsqrtCD4,
    ...
    simdata[simdata$t == 2,]$pr_c <- as.vector(1-predict.glm(censor_model_1,
                                                             newdata = data.frame(sqrtCD4_1 = simdata[simdata$t == 2,]$lagsqrtCD4_1,
                                                                                  sqrtCD4 = simdata[simdata$t == 2,]$lagsqrtCD4,
    ...
    simdata[simdata$t == 3,]$pr_c <- as.vector(1-predict.glm(censor_model_2,
                                                             newdata = data.frame(sqrtCD4_1 = simdata[simdata$t == 3,]$lagsqrtCD4_1,
                                                                                  sqrtCD4 = simdata[simdata$t == 3,]$lagsqrtCD4,
    ...
    simdata[simdata$t == 4,]$pr_c <- as.vector(1-predict.glm(censor_model_3,
                                                             newdata = data.frame(sqrtCD4_1 = simdata[simdata$t == 4,]$lagsqrtCD4_1,
                                                                                  sqrtCD4 = simdata[simdata$t == 4,]$lagsqrtCD4,
    ...
    for (j in k:0){
      ...
      if (k == j){
        update_data <- data.frame(id = rep(wideSimdata$ID,2),
                                  ...
                                  strata_1 = rep(as.numeric(200 <= wideSimdata$CD4_1_0 & wideSimdata$CD4_1_0 <= 500),2),
                                  strata_2 = rep(as.numeric(wideSimdata$CD4_1_0 > 500),2),
                                  viral_1 = rep(wideSimdata$viral_1_0,2),
                                  HIVsym_1 = rep(wideSimdata$HIVsym_1_0,2),
                                  Ap = rep(wideSimdata$Ap_0,2),
                                  strata_0cumA = c(as.numeric(200 > wideSimdata$CD4_1_0)*rep(k+1,dim(wideSimdata)[1]), 
                                                   as.numeric(200 > wideSimdata$CD4_1_0)*rep(0,dim(wideSimdata)[1])),
                                  strata_1cumA = c(as.numeric(200 <= wideSimdata$CD4_1_0 & wideSimdata$CD4_1_0 <= 500)*rep(k+1,dim(wideSimdata)[1]),
                                                   as.numeric(200 <= wideSimdata$CD4_1_0 & wideSimdata$CD4_1_0 <= 500)*rep(0,dim(wideSimdata)[1])),
                                  strata_2cumA = c(as.numeric(wideSimdata$CD4_1_0 > 500)*rep(k+1,dim(wideSimdata)[1]), 
                                                   as.numeric(wideSimdata$CD4_1_0 > 500)*rep(0,dim(wideSimdata)[1])))
  ...
  msm_fitting_data_transformed <- data.frame(id = rep(wideSimdata$ID,10), 
                                             ...
                                             strata_1 = rep(as.numeric(200 <= wideSimdata$CD4_1_0 & wideSimdata$CD4_1_0 <= 500),10),
                                             strata_2 = rep(as.numeric(wideSimdata$CD4_1_0 > 500),10),
                                             viral_1 = rep(wideSimdata$viral_1_0,10),
                                             HIVsym_1 = rep(wideSimdata$HIVsym_1_0,10),
                                             Ap = rep(wideSimdata$Ap_0,10),
                                             strata_0cumA = c(as.numeric(200 > wideSimdata$CD4_1_0)*rep(1,dim(wideSimdata)[1]), as.numeric(200 > wideSimdata$CD4_1_0)*rep(0,dim(wideSimdata)[1]), 
                                                              as.numeric(200 > wideSimdata$CD4_1_0)*rep(2,dim(wideSimdata)[1]), as.numeric(200 > wideSimdata$CD4_1_0)*rep(0,dim(wideSimdata)[1]), 
                                                              as.numeric(200 > wideSimdata$CD4_1_0)*rep(3,dim(wideSimdata)[1]), as.numeric(200 > wideSimdata$CD4_1_0)*rep(0,dim(wideSimdata)[1]),
                                                              as.numeric(200 > wideSimdata$CD4_1_0)*rep(4,dim(wideSimdata)[1]), as.numeric(200 > wideSimdata$CD4_1_0)*rep(0,dim(wideSimdata)[1]),
                                                              as.numeric(200 > wideSimdata$CD4_1_0)*rep(5,dim(wideSimdata)[1]), as.numeric(200 > wideSimdata$CD4_1_0)*rep(0,dim(wideSimdata)[1])),
                                             strata_1cumA =  c(as.numeric(200 <= wideSimdata$CD4_1_0 & wideSimdata$CD4_1_0 <= 500)*rep(1,dim(wideSimdata)[1]), rep(0,dim(wideSimdata)[1]), 
                                                               as.numeric(200 <= wideSimdata$CD4_1_0 & wideSimdata$CD4_1_0 <= 500)*rep(2,dim(wideSimdata)[1]), rep(0,dim(wideSimdata)[1]), 
                                                               as.numeric(200 <= wideSimdata$CD4_1_0 & wideSimdata$CD4_1_0 <= 500)*rep(3,dim(wideSimdata)[1]), rep(0,dim(wideSimdata)[1]),
                                                               as.numeric(200 <= wideSimdata$CD4_1_0 & wideSimdata$CD4_1_0 <= 500)*rep(4,dim(wideSimdata)[1]), rep(0,dim(wideSimdata)[1]),
                                                               as.numeric(200 <= wideSimdata$CD4_1_0 & wideSimdata$CD4_1_0 <= 500)*rep(5,dim(wideSimdata)[1]), rep(0,dim(wideSimdata)[1])),
                                             strata_2cumA = c(as.numeric(wideSimdata$CD4_1_0 > 500)*rep(1,dim(wideSimdata)[1]), rep(0,dim(wideSimdata)[1]), 
                                                              as.numeric(wideSimdata$CD4_1_0 > 500)*rep(2,dim(wideSimdata)[1]), rep(0,dim(wideSimdata)[1]), 
                                                              as.numeric(wideSimdata$CD4_1_0 > 500)*rep(3,dim(wideSimdata)[1]), rep(0,dim(wideSimdata)[1]),
                                                              as.numeric(wideSimdata$CD4_1_0 > 500)*rep(4,dim(wideSimdata)[1]), rep(0,dim(wideSimdata)[1]),
                                                              as.numeric(wideSimdata$CD4_1_0 > 500)*rep(5,dim(wideSimdata)[1]), rep(0,dim(wideSimdata)[1])))
...
MyLtmleMSM_cali_boot_hers <- function(simdata, initial_Q_t = NA, refit_weights = TRUE){
  if (refit_weights){
    treat_model_A_0 <- glm(A~ sqrtCD4_1 + sqrtCD4_2 +  viral_1 + viral_2 + HIVsym_1+ SITE2 + SITE3 + WHITE + OTHER-1, data = simdata[simdata$t == 0,], family = 'binomial')
    treat_model_A_1 <- glm(A~ Ap+sqrtCD4_1 + sqrtCD4_2 +  viral_1 + viral_2 + HIVsym_1+ SITE2 + SITE3 + WHITE + OTHER, data = simdata[simdata$t == 1,], family = 'binomial')
    treat_model_A_2 <- glm(A~ Ap+sqrtCD4_1 + sqrtCD4_2 +  viral_1 + viral_2 + HIVsym_1+ SITE2 + SITE3 + WHITE + OTHER, data = simdata[simdata$t == 2,], family = 'binomial')
