source("/home/juliette/Calibrated-weights-sequential-trial-emulation/utils/dgm_2nd_simulation_biometrics.R")
source("/home/juliette/Calibrated-weights-sequential-trial-emulation/utils/calibration_func_trials.R")
source("/home/juliette/Calibrated-weights-sequential-trial-emulation/utils/ltmle_utils.R")
library(dplyr)
library(MASS)
library(foreach)
library(doParallel)
...
for(i in c(300,500,1000,2500)){
  ...
  ci_coverage_simu_result <- readRDS(paste0("/home/juliette/Calibrated-weights-sequential-trial-emulation/HPC CI results/ci_coverage_simu_result_",i,".rds"))
  mle_comp_result <- readRDS(paste0("/home/juliette/Calibrated-weights-sequential-trial-emulation/HPC CI results/mle_ci_comp_time_weak_conf_result_",i,".rds"))
  ...
  ci_coverage_simu_result <- readRDS(paste0("/home/juliette/Calibrated-weights-sequential-trial-emulation/HPC CI results/ci_coverage_simu_strong_conf_result_",i,".rds"))
  mle_comp_result <- readRDS(paste0("/home/juliette/Calibrated-weights-sequential-trial-emulation/HPC CI results/mle_ci_comp_time_strong_conf_result_",i,".rds"))
