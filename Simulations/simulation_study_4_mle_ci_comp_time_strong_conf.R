...
###############################
setwd("~/rds/hpc-work/Calibrated-weights-sequential-trial-emulation/Simulations")
source("~/rds/hpc-work/Calibrated-weights-sequential-trial-emulation/utils/dgm_2nd_simulation_biometrics.R")
source("~/rds/hpc-work/Calibrated-weights-sequential-trial-emulation/utils/calibration_func_trials.R")
source("~/rds/hpc-work/Calibrated-weights-sequential-trial-emulation/utils/comp_time_ltmle_utils.R")
library(dplyr)
library(MASS)
library(foreach)
library(doParallel)
...
#sink()
saveRDS(simulation, file = paste0('~/rds/hpc-work/Calibrated-weights-sequential-trial-emulation/HPC CI results/mle_ci_comp_time_strong_conf_result_', as.character(l),'.rds'))
