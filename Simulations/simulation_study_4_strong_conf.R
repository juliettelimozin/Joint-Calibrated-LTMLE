...
source("~/rds/hpc-work/Calibrated-weights-sequential-trial-emulation/utils/ltmle_utils.R")
library(dplyr)
library(MASS)
library(foreach)
library(doParallel)
...
#sink()
saveRDS(simulation, file = paste0('~/rds/hpc-work/Calibrated-weights-sequential-trial-emulation/HPC CI results/ci_coverage_simu_strong_conf_result_', as.character(l),'.rds'))
