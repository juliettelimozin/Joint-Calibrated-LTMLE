...
#sink()
saveRDS(simulation, file = paste0('~/rds/hpc-work/Calibrated-weights-sequential-trial-emulation/HPC CI results/mle_ci_comp_time_weak_conf_result_', as.character(l),'.rds'))
