...
simulation_code <- function(iters, transformed = FALSE, sample_size,seeds,conf = 0.2, 
  ...
  simulation <- foreach(i = 1:iters, .combine=cbind) %dopar% {
    ...
    suppressMessages(suppressWarnings({
      ...
      Q2_2_fit <- glm(data = wideSimdata[wideSimdata$RC_2 ==1,], formula = Y_2 ~ A_2 + A_1 + X1_2 + X2_2 + X3_2 +X4_2 + X1_1 + X2_1 + X3_1 +X4_1)
      ...
      Q2_2star_cali_treat_only <- predict.glm(Q2_2star_fit_cali_treat_only, newdata = update_data, type = 'response')*(b-a) +a
      ...
      Q2_2star_cali_aggr_treat_only <- predict.glm(Q2_2star_fit_cali_aggr_treat_only, newdata = update_data, type = 'response')*(b-a) +a
      ...
      Q2_2star_cali_censor_only <- predict.glm(Q2_2star_fit_cali_censor_only, newdata = update_data, type = 'response')*(b-a) +a
      ...
      Q2_2star_cali_aggr_censor_only <- predict.glm(Q2_2star_fit_cali_aggr_censor_only, newdata = update_data, type = 'response')*(b-a) +a
      ...
      Q2_1_fit_d1_cali_treat_only <- glm(data = fitting_data[1:sample_size,], formula = Q2_2star_cali_treat_only ~ CA_1 + X1_1 + X2_1 + X3_1 + X4_1)
      Q2_1_fit_d0_cali_treat_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q2_2star_cali_treat_only ~ CA_1 + X1_1 + X2_1 + X3_1 + X4_1)
      
      logitQ2_1_cali_treat_only <- as.matrix(c(qlogis((predict.glm(Q2_1_fit_d1_cali_treat_only, 
                                                                   newdata = data.frame(CA_1 = rep(2,sample_size),
                                                                                        X1_1 = wideSimdata$X1_1, 
                                                                                        X2_1 = wideSimdata$X2_1,
                                                                                        X3_1 = wideSimdata$X3_1, 
                                                                                        X4_1 = wideSimdata$X4_1))-a)/(b-a)),
                                               qlogis((predict.glm(Q2_1_fit_d0_cali_treat_only, 
                                                                   newdata = data.frame(CA_1 = rep(0,sample_size),
                                                                                        X1_1 = wideSimdata$X1_1, 
                                                                                        X2_1 = wideSimdata$X2_1,
                                                                                        X3_1 = wideSimdata$X3_1, 
      ...
      Q2_1_fit_d1_cali_aggr_treat_only <- glm(data = fitting_data[1:sample_size,], formula = Q2_2star_cali_aggr_treat_only ~ CA_1 + X1_1 + X2_1 + X3_1 + X4_1)
      Q2_1_fit_d0_cali_aggr_treat_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q2_2star_cali_aggr_treat_only ~ CA_1 + X1_1 + X2_1 + X3_1 + X4_1)
      
      logitQ2_1_cali_aggr_treat_only <- as.matrix(c(qlogis((predict.glm(Q2_1_fit_d1_cali_aggr_treat_only, 
                                                                        newdata = data.frame(CA_1 = rep(2,sample_size),
                                                                                             X1_1 = wideSimdata$X1_1, 
                                                                                             X2_1 = wideSimdata$X2_1,
                                                                                             X3_1 = wideSimdata$X3_1, 
                                                                                             X4_1 = wideSimdata$X4_1))-a)/(b-a)),
                                                    qlogis((predict.glm(Q2_1_fit_d0_cali_aggr_treat_only, 
                                                                        newdata = data.frame(CA_1 = rep(0,sample_size),
                                                                                             X1_1 = wideSimdata$X1_1, 
                                                                                             X2_1 = wideSimdata$X2_1,
                                                                                             X3_1 = wideSimdata$X3_1, 
      ...
      Q2_1_fit_d1_cali_censor_only <- glm(data = fitting_data[1:sample_size,], formula = Q2_2star_cali_censor_only ~ CA_1 + X1_1 + X2_1 + X3_1 + X4_1)
      Q2_1_fit_d0_cali_censor_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q2_2star_cali_censor_only ~ CA_1 + X1_1 + X2_1 + X3_1 + X4_1)
      
      logitQ2_1_cali_censor_only <- as.matrix(c(qlogis((predict.glm(Q2_1_fit_d1_cali_censor_only, 
                                                                    newdata = data.frame(CA_1 = rep(2,sample_size),
                                                                                         X1_1 = wideSimdata$X1_1, 
                                                                                         X2_1 = wideSimdata$X2_1,
                                                                                         X3_1 = wideSimdata$X3_1, 
                                                                                         X4_1 = wideSimdata$X4_1))-a)/(b-a)),
                                                qlogis((predict.glm(Q2_1_fit_d0_cali_censor_only, 
                                                                    newdata = data.frame(CA_1 = rep(0,sample_size),
                                                                                         X1_1 = wideSimdata$X1_1, 
                                                                                         X2_1 = wideSimdata$X2_1,
                                                                                         X3_1 = wideSimdata$X3_1, 
      ...
      Q2_1_fit_d1_cali_aggr_censor_only <- glm(data = fitting_data[1:sample_size,], formula = Q2_2star_cali_aggr_censor_only ~ CA_1 + X1_1 + X2_1 + X3_1 + X4_1)
      Q2_1_fit_d0_cali_aggr_censor_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q2_2star_cali_aggr_censor_only ~ CA_1 + X1_1 + X2_1 + X3_1 + X4_1)
      
      logitQ2_1_cali_aggr_censor_only <- as.matrix(c(qlogis((predict.glm(Q2_1_fit_d1_cali_aggr_censor_only, 
                                                                         newdata = data.frame(CA_1 = rep(2,sample_size),
                                                                                              X1_1 = wideSimdata$X1_1, 
                                                                                              X2_1 = wideSimdata$X2_1,
                                                                                              X3_1 = wideSimdata$X3_1, 
                                                                                              X4_1 = wideSimdata$X4_1))-a)/(b-a)),
                                                     qlogis((predict.glm(Q2_1_fit_d0_cali_aggr_censor_only, 
                                                                         newdata = data.frame(CA_1 = rep(0,sample_size),
                                                                                              X1_1 = wideSimdata$X1_1, 
                                                                                              X2_1 = wideSimdata$X2_1,
                                                                                              X3_1 = wideSimdata$X3_1, 
      ...
      Q1_1star_cali_treat_only <- predict.glm(Q1_1star_fit_cali_treat_only, newdata = update_data, type = 'response')*(b-a)+a
      
      Q1_1star_fit_cali_aggr_treat_only <- glm(Y_1 ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                                               data = update_data[regimen_ind == 1,],
                                               weights = as.vector(Cweight_aggr_treat_only[regimen_ind == 1]))
      
      Q1_1star_cali_aggr_treat_only <- predict.glm(Q1_1star_fit_cali_aggr_treat_only, newdata = update_data, type = 'response')*(b-a)+a
      
      Q1_1star_fit_cali_censor_only <- glm(Y_1 ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                                           data = update_data[regimen_ind == 1,],
                                           weights = as.vector(Cweight_censor_only[regimen_ind == 1]))
      
      Q1_1star_cali_censor_only <- predict.glm(Q1_1star_fit_cali_censor_only, newdata = update_data, type = 'response')*(b-a)+a
      
      Q1_1star_fit_cali_aggr_censor_only <- glm(Y_1 ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                                                data = update_data[regimen_ind == 1,],
                                                weights = as.vector(Cweight_aggr_censor_only[regimen_ind == 1]))
      
      Q1_1star_cali_aggr_censor_only <- predict.glm(Q1_1star_fit_cali_aggr_censor_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      update_data <- data.frame(id = rep(wideSimdata$ID,2),
                                ...
                                Q2_2star_cali_treat_only = (Q2_2star_cali_treat_only-a)/(b-a),
                                Q2_2star_cali_aggr_treat_only = (Q2_2star_cali_aggr_treat_only-a)/(b-a),
                                Q2_2star_cali_censor_only = (Q2_2star_cali_censor_only-a)/(b-a),
                                Q2_2star_cali_aggr_censor_only = (Q2_2star_cali_aggr_censor_only-a)/(b-a),
                                off = logitQ2_1,
      ...
      Q2_1star_cali_treat_only <- predict.glm(Q2_1star_fit_cali_treat_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      Q2_1star_cali_aggr_treat_only <- predict.glm(Q2_1star_fit_cali_aggr_treat_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      Q2_1star_cali_censor_only <- predict.glm(Q2_1star_fit_cali_censor_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      Q2_1star_cali_aggr_censor_only <- predict.glm(Q2_1star_fit_cali_aggr_censor_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      Q2_0_fit_d1_cali_treat_only <- glm(data = fitting_data[1:sample_size,], formula = Q2_1star_cali_treat_only ~ A_0)
      Q2_0_fit_d0_cali_treat_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q2_1star_cali_treat_only ~ A_0)
      
      logitQ2_0_cali_treat_only <- as.matrix(c(qlogis((predict.glm(Q2_0_fit_d1_cali_treat_only, 
                                                                  newdata = data.frame(A_0 = rep(1,sample_size)))-a)/(b-a)),
                                              qlogis((predict.glm(Q2_0_fit_d0_cali_treat_only, 
                                                                  newdata = data.frame(A_0 = rep(0,sample_size)))-a)/(b-a))
      ))
      
      Q2_0_fit_d1_cali_aggr_treat_only <- glm(data = fitting_data[1:sample_size,], formula = Q2_1star_cali_aggr_treat_only ~ A_0)
      Q2_0_fit_d0_cali_aggr_treat_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q2_1star_cali_aggr_treat_only ~ A_0)
      
      logitQ2_0_cali_aggr_treat_only <- as.matrix(c(qlogis((predict.glm(Q2_0_fit_d1_cali_aggr_treat_only, 
                                                                        newdata = data.frame(A_0 = rep(1,sample_size)))-a)/(b-a)),
                                                    qlogis((predict.glm(Q2_0_fit_d0_cali_aggr_treat_only, 
                                                                        newdata = data.frame(A_0 = rep(0,sample_size)))-a)/(b-a))
      ))
      
      Q2_0_fit_d1_cali_censor_only <- glm(data = fitting_data[1:sample_size,], formula = Q2_1star_cali_censor_only ~ A_0)
      Q2_0_fit_d0_cali_censor_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q2_1star_cali_censor_only ~ A_0)
      
      logitQ2_0_cali_censor_only <- as.matrix(c(qlogis((predict.glm(Q2_0_fit_d1_cali_censor_only, 
                                                                    newdata = data.frame(A_0 = rep(1,sample_size)))-a)/(b-a)),
                                                qlogis((predict.glm(Q2_0_fit_d0_cali_censor_only, 
                                                                    newdata = data.frame(A_0 = rep(0,sample_size)))-a)/(b-a))
      ))
      
      Q2_0_fit_d1_cali_aggr_censor_only <- glm(data = fitting_data[1:sample_size,], formula = Q2_1star_cali_aggr_censor_only ~ A_0)
      Q2_0_fit_d0_cali_aggr_censor_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q2_1star_cali_aggr_censor_only ~ A_0)
      
      logitQ2_0_cali_aggr_censor_only <- as.matrix(c(qlogis((predict.glm(Q2_0_fit_d1_cali_aggr_censor_only, 
                                                                         newdata = data.frame(A_0 = rep(1,sample_size)))-a)/(b-a)),
                                                     qlogis((predict.glm(Q2_0_fit_d0_cali_aggr_censor_only, 
                                                                         newdata = data.frame(A_0 = rep(0,sample_size)))-a)/(b-a))
      ))
      ...
      Q1_0_fit_d1_cali_treat_only <- glm(data = fitting_data[1:sample_size,], formula = Q1_1star_cali_treat_only ~ A_0 + X1_0 + X2_0 + X3_0 + X4_0 )
      Q1_0_fit_d0_cali_treat_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q1_1star_cali_treat_only ~ A_0 + X1_0 + X2_0 + X3_0 + X4_0)
      
      logitQ1_0_cali_treat_only <- as.matrix(c(qlogis((predict.glm(Q1_0_fit_d1_cali_treat_only, 
                                                                   newdata = data.frame(A_0 = rep(1,sample_size),
                                                                                        X1_0 = wideSimdata$X1_0, 
                                                                                        X2_0 = wideSimdata$X2_0,
                                                                                        X3_0 = wideSimdata$X3_0, 
                                                                                        X4_0 = wideSimdata$X4_0))-a)/(b-a)),
                                               qlogis((predict.glm(Q1_0_fit_d0_cali_treat_only, 
                                                                   newdata = data.frame(A_0 = rep(0,sample_size),
                                                                                        X1_0 = wideSimdata$X1_0, 
                                                                                        X2_0 = wideSimdata$X2_0,
                                                                                        X3_0 = wideSimdata$X3_0, 
      ...
      Q1_0_fit_d1_cali_aggr_treat_only <- glm(data = fitting_data[1:sample_size,], formula = Q1_1star_cali_aggr_treat_only ~ A_0 + X1_0 + X2_0 + X3_0 + X4_0 )
      Q1_0_fit_d0_cali_aggr_treat_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q1_1star_cali_aggr_treat_only ~ A_0 + X1_0 + X2_0 + X3_0 + X4_0)
      
      logitQ1_0_cali_aggr_treat_only <- as.matrix(c(qlogis((predict.glm(Q1_0_fit_d1_cali_aggr_treat_only, 
                                                                        newdata = data.frame(A_0 = rep(1,sample_size),
                                                                                             X1_0 = wideSimdata$X1_0, 
                                                                                             X2_0 = wideSimdata$X2_0,
                                                                                             X3_0 = wideSimdata$X3_0, 
                                                                                             X4_0 = wideSimdata$X4_0))-a)/(b-a)),
                                                    qlogis((predict.glm(Q1_0_fit_d0_cali_aggr_treat_only, 
                                                                        newdata = data.frame(A_0 = rep(0,sample_size),
                                                                                             X1_0 = wideSimdata$X1_0, 
                                                                                             X2_0 = wideSimdata$X2_0,
                                                                                             X3_0 = wideSimdata$X3_0, 
      ...
      Q1_0_fit_d1_cali_censor_only <- glm(data = fitting_data[1:sample_size,], formula = Q1_1star_cali_censor_only ~ A_0 + X1_0 + X2_0 + X3_0 + X4_0 )
      Q1_0_fit_d0_cali_censor_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q1_1star_cali_censor_only ~ A_0 + X1_0 + X2_0 + X3_0 + X4_0)
      
      logitQ1_0_cali_censor_only <- as.matrix(c(qlogis((predict.glm(Q1_0_fit_d1_cali_censor_only, 
                                                                    newdata = data.frame(A_0 = rep(1,sample_size),
                                                                                         X1_0 = wideSimdata$X1_0, 
                                                                                         X2_0 = wideSimdata$X2_0,
                                                                                         X3_0 = wideSimdata$X3_0, 
                                                                                         X4_0 = wideSimdata$X4_0))-a)/(b-a)),
                                                qlogis((predict.glm(Q1_0_fit_d0_cali_censor_only, 
                                                                    newdata = data.frame(A_0 = rep(0,sample_size),
                                                                                         X1_0 = wideSimdata$X1_0, 
                                                                                         X2_0 = wideSimdata$X2_0,
                                                                                         X3_0 = wideSimdata$X3_0, 
      ...
      Q1_0_fit_d1_cali_aggr_censor_only <- glm(data = fitting_data[1:sample_size,], formula = Q1_1star_cali_aggr_censor_only ~ A_0 + X1_0 + X2_0 + X3_0 + X4_0 )
      Q1_0_fit_d0_cali_aggr_censor_only <- glm(data = fitting_data[(sample_size+1):(sample_size*2),], formula = Q1_1star_cali_aggr_censor_only ~ A_0 + X1_0 + X2_0 + X3_0 + X4_0)
      
      logitQ1_0_cali_aggr_censor_only <- as.matrix(c(qlogis((predict.glm(Q1_0_fit_d1_cali_aggr_censor_only, 
                                                                         newdata = data.frame(A_0 = rep(1,sample_size),
                                                                                              X1_0 = wideSimdata$X1_0, 
                                                                                              X2_0 = wideSimdata$X2_0,
                                                                                              X3_0 = wideSimdata$X3_0, 
                                                                                              X4_0 = wideSimdata$X4_0))-a)/(b-a)),
                                                     qlogis((predict.glm(Q1_0_fit_d0_cali_aggr_censor_only, 
                                                                         newdata = data.frame(A_0 = rep(0,sample_size),
                                                                                              X1_0 = wideSimdata$X1_0, 
                                                                                              X2_0 = wideSimdata$X2_0,
                                                                                              X3_0 = wideSimdata$X3_0, 
      ...
      Q0_0star_cali_treat_only <- predict.glm(Q0_0star_fit_cali_treat_only, newdata = update_data, type = 'response')*(b-a)+a
      
      Q0_0star_fit_cali_aggr_treat_only <- glm(Y_0 ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                                               data = update_data[regimen_ind == 1,],
                                               weights = as.vector(Cweight_aggr_treat_only[regimen_ind == 1]))
      
      Q0_0star_cali_aggr_treat_only <- predict.glm(Q0_0star_fit_cali_aggr_treat_only, newdata = update_data, type = 'response')*(b-a)+a
      
      Q0_0star_fit_cali_censor_only <- glm(Y_0 ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                                           data = update_data[regimen_ind == 1,],
                                           weights = as.vector(Cweight_censor_only[regimen_ind == 1]))
      
      Q0_0star_cali_censor_only <- predict.glm(Q0_0star_fit_cali_censor_only, newdata = update_data, type = 'response')*(b-a)+a
      
      Q0_0star_fit_cali_aggr_censor_only <- glm(Y_0 ~ intercept + cumA + offset(off) - 1, family = 'quasibinomial', 
                                                data = update_data[regimen_ind == 1,],
                                                weights = as.vector(Cweight_aggr_censor_only[regimen_ind == 1]))
      
      Q0_0star_cali_aggr_censor_only <- predict.glm(Q0_0star_fit_cali_aggr_censor_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      update_data <- data.frame(id = rep(wideSimdata$ID,2),
                                ...
                                Q2_1star_cali_treat_only = (Q2_1star_cali_treat_only-a)/(b-a),
                                Q2_1star_cali_aggr_treat_only = (Q2_1star_cali_aggr_treat_only-a)/(b-a),
                                Q2_1star_cali_censor_only = (Q2_1star_cali_censor_only-a)/(b-a),
                                Q2_1star_cali_aggr_censor_only = (Q2_1star_cali_aggr_censor_only-a)/(b-a),
                                off = logitQ2_0,
      ...
      Q2_0star_cali_treat_only <- predict.glm(Q2_0star_fit_cali_treat_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      Q2_0star_cali_aggr_treat_only <- predict.glm(Q2_0star_fit_cali_aggr_treat_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      Q2_0star_cali_censor_only <- predict.glm(Q2_0star_fit_cali_censor_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      Q2_0star_cali_aggr_censor_only <- predict.glm(Q2_0star_fit_cali_aggr_censor_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      update_data <- data.frame(id = rep(wideSimdata$ID,2),
                                ...
                                Q1_1star_cali_treat_only = (Q1_1star_cali_treat_only-a)/(b-a),
                                Q1_1star_cali_aggr_treat_only = (Q1_1star_cali_aggr_treat_only-a)/(b-a),
                                Q1_1star_cali_censor_only = (Q1_1star_cali_censor_only-a)/(b-a),
                                Q1_1star_cali_aggr_censor_only = (Q1_1star_cali_aggr_censor_only-a)/(b-a),
                                off = logitQ1_0,
      ...
      Q1_0star_cali_treat_only <- predict.glm(Q1_0star_fit_cali_treat_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      Q1_0star_cali_aggr_treat_only <- predict.glm(Q1_0star_fit_cali_aggr_treat_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      Q1_0star_cali_censor_only <- predict.glm(Q1_0star_fit_cali_censor_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      Q1_0star_cali_aggr_censor_only <- predict.glm(Q1_0star_fit_cali_aggr_censor_only, newdata = update_data, type = 'response')*(b-a)+a
      ...
      msm_cali_treat_only <- glm(Y_cali_treat_only ~ cumA, data = msm_fitting_data)
      msm_cali_aggr_treat_only <- glm(Y_cali_aggr_treat_only ~ cumA, data = msm_fitting_data)
      msm_cali_censor_only <- glm(Y_cali_censor_only ~ cumA, data = msm_fitting_data)
      msm_cali_aggr_censor_only <- glm(Y_cali_aggr_censor_only ~ cumA, data = msm_fitting_data)
    ...
    c(PP_strat$coefficients[1],
      ...
      msm_cali_treat_only$coefficients[1],
      msm_cali_aggr_treat_only$coefficients[1],
      msm_cali_censor_only$coefficients[1],
      msm_cali_aggr_censor_only$coefficients[1],
      ...
      msm_cali_treat_only$coefficients[2],
      msm_cali_aggr_treat_only$coefficients[2],
      msm_cali_censor_only$coefficients[2],
      msm_cali_aggr_censor_only$coefficients[2]
    )
  }
...
sink("3_visits_with_censoring_linear_models.txt")
