...
scenarios <- tidyr::crossing(size,miss, treat)
...
save(meandiffs, file = paste("Simulation results/meandiffs_singletrial_low_scneario2_",as.character(l),".rda", sep = ""))
save(objectives, file = paste("Simulation results/objectives_singletrial_low_scneario2_",as.character(l),".rda", sep = ""))
save(hr_estimates, file = paste("Simulation results/hr_estimates_singletrial_low_scneario2_",as.character(l),".rda", sep = ""))
save(mr_estimates, file = paste("Simulation results/mr_estimates_singletrial_low_scneario2_",as.character(l),".rda", sep = ""))
